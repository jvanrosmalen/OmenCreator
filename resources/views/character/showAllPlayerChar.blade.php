...
<div class='container'>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a id="tab1" data-toggle="tab" href="#active_chars">Actief</a></li>
		<li><a id="tab2" data-toggle="tab" href="#inactive_chars">Niet-actief</a></li>
		<li><a id="tab3" data-toggle="tab" href="#dead_chars">Gestorven</a></li>
	</ul>
				
	<div id="all_chars" class="tab-content">
		<div id="active_chars" class="tab-pane fade in active">
			<div class='row'>
				<div class="col-xs-12">

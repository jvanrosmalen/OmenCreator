				            ...
				            @foreach ($coming_events as $event)
				                <tr id="{{$event->id}}">
				                    ...
				                    <td class="col-xs-2">
										...
										<a href="/larpeventaddplayer/{{ $event->id }}" class="btn btn-warning btn-xs show-char-btn" data-toggle="tooltip" title="Beheren Spelers">
									   ...
									   <a href="/larpeventdeletewarning/{{ $event->id }}" class="btn btn-danger btn-xs show-char-btn" data-toggle="tooltip" title="Verwijder Event">

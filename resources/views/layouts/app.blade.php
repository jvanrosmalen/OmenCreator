...
<html lang="en">
<head>
    <base href="http://{{env('GLOBAL_BASE','www.omencreator.be')}}/">
    <meta charset="utf-8">
	...
	<link href="{{ URL::asset('css/larpEvent.css') }}" rel='stylesheet' type='text/css'>
    ...
    <script src="{{ URL::asset('js/larpevent/larpEvent.js') }}"></script>
                ...
                <ul class="nav navbar-nav">
                	...
                	<li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                        	<li><a href="{{ url('my_playercharacters') }}">Mijn Spelerkarakter</a></li>

...
@section('content')
	<div class='container'>
		...
		<form action="spark_selection_submit/{{$sparkIndex}}" method="POST">
            ...
            <div class="row">
                <div class="row well">
                    ...
                    <div class="col-xs-10">
                        ...
                        in het verleden wat grondstoffen kunnen ruilen en/of kopen 
                        die je nog bijhebt.<br>
                        Je ontvangt 1 grondstof van het type: <span id='resourceString'></span> 		
                    </div>
                    <div class="col-xs-1">
                    </div>
                </div>
    ...
    <script>
		SparkChoice.setEventHandlersSelection15();
	</script>
@endsection